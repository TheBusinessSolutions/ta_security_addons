...
# Part of BrowseInfo. See LICENSE file for full copyright and licensing details.
{
    ...
    """,
    'author': 'BROWSEINFO',
    'website': 'https://www.browseinfo.com/demo-request?app=bi_warehouse_product_availability_in_so&version=17&edition=Community',
    "depends":["base",
               "sale_management",
               "sale",
               "stock",
    ...
    'installable': True,
    'auto_install': False,
    'live_test_url':'https://www.browseinfo.com/demo-request?app=bi_warehouse_product_availability_in_so&version=17&edition=Community',
